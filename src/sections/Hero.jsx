                    ...
                    <div className="space-y-8">
                        <div className="animate-fade-in">
                            <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass text-sm text-primary">
                                <span className="w-2 h-2 bg-primary rounded-full" />
                                    Software Engineer - React Specilist
                                </span>
                        ...
                        <div className="space-y-4">
                            ...
                            className="text-lg text-muted-foreground max-w-lg animate-fade-in animation-delay-200">
                                Hi, I'm Ansh Pokhriyal - a software engineer specializing in React , Next.js and JavaScript. I build scalable , performant web applications that users love.
                            </p>
                        </div>
                    ...
                    <div className="relative animate-fade-in animation-delay-300">
                        ...
                        <div className="relative max-w-md mx-auto">
                            <div className='absolute inset-0 rounded-3xl bg-gradient-to-br from-primary/30 via-transparent to-primary/10 blur-2xl animate-pulse'/>
                                <div className="relative glass rounded-3-xl p-2 glow-border">
                                    <img
                                        src="/profile-photo2.jpg"
                                        alt="Ansh Pokhriyal" className="w-full aspect-[4/5]" object-cover rounded-2xl
                                    />
                    ...
                    <div className='flex animate-marquee'>
                        {[...skills,...skills].map((skill,idx) => (
                            <div key={idx} className='flex-shrink-0 px-8 py-4'>
                                <span className='text-xl font-semiboid text-muted-foreground/50 hover:text-muted-foreground transition-colors'>{skill}</span>
                            </div>
                        ))}
                   </div>
                </div>
